...
#### 2F
```{r 2F, warning = FALSE,message=FALSE,fig.height = 10,fig.width=5}
...
```{r 5H-preparation, warning = FALSE,message=FALSE}
tmp<-tmp.5C
colnames(tmp)[6]<-'AUC'
...
```{r 5H-stepwise, warning = FALSE,message=T}
step$anova
```

#### 5H-table
```{r 5H-table, warning = FALSE,message=FALSE}
...
#### 5I
```{r 5I, warning = FALSE,message=FALSE,fig.height = 3,fig.width=3}
...
### Fig S1
#### S1A
```{r S1A, warning = FALSE,message=FALSE,fig.height = 4,fig.width=4}
replicate.sd<-list()
cell.sd<-list()
...
#### S1C
```{r S1C, warning = FALSE,message=FALSE,fig.height = 3,fig.width=9}
